...
//      }
      ...
      if ($item->name) {
        $element[$delta]['name'] = [
          '#type' => 'item',
          '#title' => $this->t('Name'),
          '#markup' => "{$item->name} <a href=\"https://orcid.org/{$item->orcid}\" target=\"_blank\"><img src=\"/themes/custom/islandora_muni/images/ORCID-iD_icon_vector.svg\" width=\"16px\"/></a>; {$item->institution_affiliation} <a href=\"https://ror.org/{$item->ror}\" target=\"_blank\"><img src=\"/themes/custom/islandora_muni/images/ror-icon-rgb.svg\" width=\"24px\"/></a>, {$item->department}",
        ];
      }
 ...
 //         '#type' => 'item',
 //         '#title' => $this->t('ROR'),
 //         '#markup' => "<a href=\"https://ror.org/{$item->ror}\" target=\"_blank\"><img src=\"/themes/custom/islandora_muni/images/ror-icon-rgb.svg\" width=\"32px\"/></a>",
 ...
 //     }
      ...
      if ($item->institution_affiliation) {
        $element[$delta]['institution_affiliation'] = [
          ...
          '#markup' => "{$item->institution_affiliation} <a href=\"https://ror.org/{$item->ror}\" target=\"_blank\"><img src=\"/themes/custom/islandora_muni/images/ror-icon-rgb.svg\" width=\"24px\"/></a>, {$item->department}",
        ];
      }
